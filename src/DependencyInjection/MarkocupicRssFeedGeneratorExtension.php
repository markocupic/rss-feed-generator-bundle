...
use Markocupic\RssFeedGeneratorBundle\DependencyInjection\Configuration;

/**
 * Class MarkocupicRssFeedGeneratorExtension
 */
class MarkocupicRssFeedGeneratorExtension extends Extension
{
